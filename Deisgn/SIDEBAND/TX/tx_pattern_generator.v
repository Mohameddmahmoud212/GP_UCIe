...
// 	end //i_pattern_detected pulse  not level 
// 	else if (i_pattern_detected || (more_four_ittr_cntr_en && more_four_ittr_cntr < 3)) begin
// 		more_four_ittr_cntr_en 	<= 1;
// 		more_four_ittr_cntr 	<= more_four_ittr_cntr +1;
// 	end
// 	else if (more_four_ittr_cntr == 3) begin
// 		o_start_pattern_done 	<= 1; // more 4 iteration  send 
// 		more_four_ittr_cntr 	<= 0;
// 		more_four_ittr_cntr_en 	<= 0;
// 	end
// 	else begin
