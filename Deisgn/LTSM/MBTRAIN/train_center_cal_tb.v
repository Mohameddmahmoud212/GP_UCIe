...
module tb_vref_cal_wrapper;
    ...
    train_center_cal_wrapper dut (
        ...
        .i_tx_lanes_result(i_rx_lanes_result),

        .o_sideband_message(o_sideband_message),
        .o_valid(o_valid),

        .o_pt_en(o_pt_en),
        .o_mainband_or_valtrain_test(o_mainband_or_valtrain_test_out),
        .o_pi_step(o_pi_step),
        .o_traincenter_ack(o_valvref_ack),
        .o_center_fail(o_valvref_fail),
        .o_center_lane_mask(o_valvref_lane_mask)
    );
    ...
    initial begin
        ...
        i_test_ack      = 1'b0;
        i_rx_lanes_result = 16'hFFFF; // all lanes pass
        i_mainband_or_valtrain_test = 1'b1; // VALVREF (val/train path)
        i_lfsr_or_perlane = 1'b1 ;
        // reset
        ...
        if (o_valvref_lane_mask !== 16'hFFFF) begin
            $display("ERROR: o_valvref_lane_mask unexpected.");
            $stop;
        end
